...
|---|---:|---:|---:|
| Phase A baut | Ja (Expo-Export) | Ja | Ja |
| Phase B baut | — | — | — |
| Phase C baut | — | — | — |
| manuelle Codeänderungen | 0 | 0 | 0 |
| gesamte KI-Runs | 1 Root-Run (+3 Sub-Agenten) | 1 Root-Run (+8 Sub-Agenten) | 1 Root-Run (+3 Sub-Agenten) |
| Anforderungen Phase A (von 30) | 29,5 vorläufig | 29,5 vorläufig | 29 vorläufig |
| Tests Phase A bestanden / gesamt | 4 / 4 | 4 / 4 | 13 / 14 |
| Dauer Phase A | 38 min 04 s | 1 h 03 min 04 s | 36 min 12 s |
| Dauer Phase C | — | — | — |
| bekannte Bugs nach Phase B | Phase B offen; 2 QA-Findings aus Phase A | Phase B offen; Session durch Nutzungslimit beendet | Phase B offen; 1 Bug aus Phase A |
